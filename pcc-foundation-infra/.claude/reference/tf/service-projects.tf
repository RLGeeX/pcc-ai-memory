module "cs-svc-prod1-svc-vjis" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 18.0"

  name            = "prod1-service"
  project_id      = "prod1-svc-vjis"
  org_id          = var.org_id
...
module "cs-svc-prod2-svc-vjis" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 18.0"

  name            = "prod2-service"
  project_id      = "prod2-svc-vjis"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = local.folder_map["Production"].id
...
module "cs-svc-nonprod1-svc-vjis" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 18.0"

  name            = "nonprod1-service"
  project_id      = "nonprod1-svc-vjis"
  org_id          = var.org_id
  billing_account = var.billing_account
...
module "cs-svc-nonprod2-svc-vjis" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 18.0"

  name            = "nonprod2-service"
  project_id      = "nonprod2-svc-vjis"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = local.folder_map["Non-Production"].id
