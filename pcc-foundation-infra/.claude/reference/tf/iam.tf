...
module "cs-projects-iam-2-loggingviewer" {
  ...
  bindings = {
    "roles/logging.viewer" = [
      "group:gcp-logging-monitoring-viewers@pcconnect.ai",
    ]
  }
}
...
module "cs-projects-iam-3-bigquerydataViewer" {
  ...
  bindings = {
    "roles/bigquery.dataViewer" = [
      "group:gcp-security-admins@pcconnect.ai",
    ]
  }
}
...
module "cs-service-projects-iam-4-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-prod1-svc-vjis.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-5-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-prod2-svc-vjis.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-6-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-nonprod1-svc-vjis.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-7-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-nonprod2-svc-vjis.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
