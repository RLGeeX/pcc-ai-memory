...
**Architecture**:
- Instances start from public `debian-cloud/debian-13` image
...
**File**: `$HOME/pcc/infra/pcc-devops-infra/images/wireguard-base/image-config.yaml`
...
**File**: `$HOME/pcc/infra/pcc-devops-infra/images/wireguard-base/build-image.sh`
...
**File**: `$HOME/pcc/infra/pcc-devops-infra/terraform/environments/nonprod/startup-script-slim.sh`
...
**Via gcloud**:
```bash
cd $HOME/pcc/infra/pcc-devops-infra/images/wireguard-base
...
- `$HOME/pcc/infra/pcc-devops-infra/images/wireguard-base/image-config.yaml` (NEW)
- `$HOME/pcc/infra/pcc-devops-infra/images/wireguard-base/build-image.sh` (NEW)
- `$HOME/pcc/infra/pcc-devops-infra/terraform/environments/nonprod/wireguard-vpn.tf` (UPDATE)
- `$HOME/pcc/infra/pcc-devops-infra/terraform/environments/nonprod/startup-script-slim.sh` (NEW)
